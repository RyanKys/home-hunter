package io.github.ryank.homehunter.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("homehunter");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("homehunter");
        ...
        config.getMapConfigs().put("io.github.ryank.homehunter.domain.*", initializeDomainMapConfig(jHipsterProperties));
